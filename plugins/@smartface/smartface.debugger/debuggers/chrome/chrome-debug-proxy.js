...
define("node_modules/@smartface/smartface.debugger/debuggers/chrome/MessageReader",[], function(require, exports, module) {
...
(function() {
    ...
    this.$checkForWholeMessage = function() {
        ...
        console.log("RECEIVE>", fullResponse.toString(), this.$received.length);
        return fullResponse;
    };
...
define("node_modules/@smartface/smartface.debugger/debuggers/chrome/Debugger",[], function(require, exports, module) {
var net = require("net");
...
try {
    ...
    console.log(execSync("which node", {encoding: "utf8"}));
}
catch (ex) {
}
...
(function() {
    ...
    this.connect = function(options) {
        getDebuggerData(options.port, function(err, res) {
            ...
            if (tabs.length > 1)
                console.log("connecting to first tab from " + tabs.length, tabs);
    ...
    this.connectToV8 = function(options) {
        ...
        connection.on("connect", function() {
            ...
            broadcast({ $: "connected", mode: "v8-Smf" });
        });
    ...
    this.disconnect = function() {
        ...
        if (this.ws)
            this.ws.close();
        if (this.v8Socket && this.v8Socket.close)
            this.v8Socket.close();
    };
...
function request(options, callback) {
    ...
    socket.on("connect", function() {
        console.log("GET " + options.path + " TLS/1.1, HTTP/1.1\r\nConnection: Upgrade\r\n\r\n");
        socket.write("GET " + options.path + " TLS/1.1, /HTTP/1.1\r\nConnection: close\r\n\r\n");
    });
}
...
define("node_modules/@smartface/smartface.debugger/debuggers/chrome/chrome-debug-proxy",[], function(require, exports, module) {
...
var socketPath = process.env.HOME + "/workspace/.c9/chrome.sock";
if (IS_WINDOWS)
