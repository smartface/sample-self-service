...
const ItemLeaveManagement = extend(FlexLayout)(
	...
	function(_super, props) {
		...
		const dividerContainerStyle = getCombinedStyle(".flexLayout", {
			height: 1,
			borderColor: Color.create(255, 143, 17, 17),
			width: null,
			backgroundColor: Color.create(255, 255, 255, 255)
		});
		var dividerContainer = new FlexLayout(dividerContainerStyle);
		this.addChild(dividerContainer);
		...
		var flexlayout5 = new HorizontalDivider(flexlayout5Style, "itemLeaveManagement");
		dividerContainer.addChild(flexlayout5);
		...
		//assign the children of dividerContainer
		dividerContainer.children = Object.assign({}, {
