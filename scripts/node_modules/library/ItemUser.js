...
const ItemUser = extend(FlexLayout)(
	...
	function(_super, props) {
		...
		const imageview40Style = getCombinedStyle(".imageView", {
			width: 60,
			height: 60,
			marginLeft: 15,
		...
		var imageview40 = new ImageView(imageview40Style);
		flexlayout160.addChild(imageview40);
		...
		const label192Style = getCombinedStyle(".label .label-list-item-value", {
			text: "Adam Stewart",
			width: null,
			height: 30,
		...
		var label192 = new Label(label192Style);
		flexlayout163.addChild(label192);
		
		const label192_1Style = getCombinedStyle(".label .label-list-item-value", {
			text: "Manager of Sales & Marketing",
			width: null,
			height: 30,
			font: Font.create("Arial", "12", Font.NORMAL)
		});
		var label192_1 = new Label(label192_1Style);
		flexlayout163.addChild(label192_1);
