...
const ItemApproval = extend(FlexLayout)(
	...
	function(_super, props) {
		...
		const label570Style = getCombinedStyle(".label .label-list-item-value", {
			width: null,
			height: null,
			text: "Adam Stewart",
			textColor: Color.create(255, 74, 74, 74),
		...
		var label570 = new Label(label570Style);
		flexlayout255.addChild(label570);
		
		const label571Style = getCombinedStyle(".label .label-list-item-value", {
			width: null,
			height: null,
		...
		var label571 = new Label(label571Style);
		flexlayout255.addChild(label571);
		
		const label572Style = getCombinedStyle(".label .label-list-item-value", {
			width: null,
			height: null,
		...
		var label572 = new Label(label572Style);
		flexlayout255.addChild(label572);
