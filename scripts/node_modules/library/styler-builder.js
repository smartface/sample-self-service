...
const styler = require("@smartface/styler/lib/flatStyler");
 ...
 * @param _className
 * @param _userStyle {optional}
 * @param onlyLayoutProps {optional} 
 * @return properties object.
 */
...
function getOneProp(key, value) {
  ...
  if (ENUMS[key]) {
    ...
    res = Font.create(value.family || "Arial", value.size || 12, getFontStyle(value));
  }
  else {
    res = value;
  }
