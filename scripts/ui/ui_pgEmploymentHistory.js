...
// Constructor
function $PgEmploymentHistory(_super, props) {
  ...
  pageContextPatch(this, "pgEmploymentHistory");
}
$PgEmploymentHistory.$$styleContext = {
  classNames: ".page",
  userProps: {
...
const $PgEmploymentHistory_ = Page($PgEmploymentHistory);
...
module.exports = $PgEmploymentHistory_;