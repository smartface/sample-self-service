...
$PgOutOfOffice.$$styleContext = {
	...
	headerBar: {
		...
		userProps: { backgroundColor: 'rgba( 255, 255, 255, 1 )', visible: false }
	}
};
...
function $MainContainer(_super, pageInstance) {
	...
	addChild.call(
		this,
		'flexlayout48',
		$MainContainer$$Flexlayout48_,
		pageInstance
	);
	addChild.call(
		this,
		'dateContainer',
		$MainContainer$$DateContainer_,
		pageInstance
	);
	addChild.call(
		this,
		'intExtContainer',
		$MainContainer$$IntExtContainer_,
		pageInstance
	);
	addChild.call(
		this,
		'noteContainer',
		$MainContainer$$NoteContainer_,
		pageInstance
	);
...
function $MainContainer$$Flexlayout48(_super, pageInstance) {
	...
	addChild.call(
		this,
		'outOfOffice',
		$MainContainer$$Flexlayout48$$OutOfOffice_,
		pageInstance
	);
}
$MainContainer$$Flexlayout48.$$styleContext = {
	classNames: '.flexLayout',
	defaultClassNames: '.default_common .default_flexLayout',
	userProps: { height: 59, paddingLeft: 10, paddingRight: 10, width: null }
};
...
const $MainContainer$$Flexlayout48$$OutOfOffice_ = ListItemSwitch(
	$MainContainer$$Flexlayout48$$OutOfOffice
);
...
function $MainContainer$$DateContainer(_super, pageInstance) {
	...
	addChild.call(
		this,
		'startTitle',
		$MainContainer$$DateContainer$$StartTitle_,
		pageInstance
	);
	addChild.call(
		this,
		'flexlayout742',
		$MainContainer$$DateContainer$$Flexlayout742_,
		pageInstance
	);
	addChild.call(
		this,
		'endTitle',
		$MainContainer$$DateContainer$$EndTitle_,
		pageInstance
	);
	addChild.call(
		this,
		'flexlayout742_1',
		$MainContainer$$DateContainer$$Flexlayout742_1_,
		pageInstance
	);
}
...
const $MainContainer$$DateContainer_ = FlexLayout(
	$MainContainer$$DateContainer
);
function $MainContainer$$DateContainer$$StartTitle(_super, pageInstance) {
	_super(this, { text: 'START' });
...
$MainContainer$$DateContainer$$StartTitle.$$styleContext = {
	...
	userProps: { font: null, height: 25, width: null }
};
const $MainContainer$$DateContainer$$StartTitle_ = TextView(
	$MainContainer$$DateContainer$$StartTitle
);
...
function $MainContainer$$DateContainer$$Flexlayout742(_super, pageInstance) {
	...
	addChild.call(
		this,
		'startDatePicker',
		$MainContainer$$DateContainer$$Flexlayout742$$StartDatePicker_,
		pageInstance
	);
	addChild.call(
		this,
		'startTimePicker',
		$MainContainer$$DateContainer$$Flexlayout742$$StartTimePicker_,
		pageInstance
	);
}
$MainContainer$$DateContainer$$Flexlayout742.$$styleContext = {
	...
	defaultClassNames: '.default_common .default_flexLayout',
	userProps: {
		flexProps: { flexDirection: 'ROW', justifyContent: 'SPACE_BETWEEN' },
		height: 45,
		marginTop: 10,
		width: null
	}
};
const $MainContainer$$DateContainer$$Flexlayout742_ = FlexLayout(
	$MainContainer$$DateContainer$$Flexlayout742
);
function $MainContainer$$DateContainer$$Flexlayout742$$StartDatePicker(
	_super,
	pageInstance
) {
	_super(this);
...
$MainContainer$$DateContainer$$Flexlayout742$$StartDatePicker.$$styleContext = {
	...
	defaultClassNames: '.default_common .default_flexLayout',
	userProps: {
		flexProps: { positionType: 'RELATIVE', flexGrow: null },
		height: 45,
		left: 0,
		top: 0,
		width: 140
...
const $MainContainer$$DateContainer$$Flexlayout742$$StartDatePicker_ = PickerContainer(
	$MainContainer$$DateContainer$$Flexlayout742$$StartDatePicker
);

function $MainContainer$$DateContainer$$Flexlayout742$$StartTimePicker(
	_super,
	pageInstance
) {
	_super(this);
...
const $MainContainer$$DateContainer$$Flexlayout742$$StartTimePicker_ = PickerContainer(
	$MainContainer$$DateContainer$$Flexlayout742$$StartTimePicker
);

function $MainContainer$$DateContainer$$EndTitle(_super, pageInstance) {
	_super(this, { text: 'END' });
...
const $MainContainer$$DateContainer$$EndTitle_ = TextView(
	$MainContainer$$DateContainer$$EndTitle
);
...
function $MainContainer$$DateContainer$$Flexlayout742_1(_super, pageInstance) {
	...
	addChild.call(
		this,
		'endDatePicker',
		$MainContainer$$DateContainer$$Flexlayout742_1$$EndDatePicker_,
		pageInstance
	);
	addChild.call(
		this,
		'endTimePicker',
		$MainContainer$$DateContainer$$Flexlayout742_1$$EndTimePicker_,
		pageInstance
	);
}
...
const $MainContainer$$DateContainer$$Flexlayout742_1_ = FlexLayout(
	$MainContainer$$DateContainer$$Flexlayout742_1
);
function $MainContainer$$DateContainer$$Flexlayout742_1$$EndDatePicker(
	_super,
	pageInstance
) {
	_super(this);
...
const $MainContainer$$DateContainer$$Flexlayout742_1$$EndDatePicker_ = PickerContainer(
	$MainContainer$$DateContainer$$Flexlayout742_1$$EndDatePicker
);

function $MainContainer$$DateContainer$$Flexlayout742_1$$EndTimePicker(
	_super,
	pageInstance
) {
	_super(this);
...
const $MainContainer$$DateContainer$$Flexlayout742_1$$EndTimePicker_ = PickerContainer(
	$MainContainer$$DateContainer$$Flexlayout742_1$$EndTimePicker
);
...
function $MainContainer$$IntExtContainer(_super, pageInstance) {
	...
	addChild.call(
		this,
		'intExtTitle',
		$MainContainer$$IntExtContainer$$IntExtTitle_,
		pageInstance
	);
	addChild.call(
		this,
		'internal',
		$MainContainer$$IntExtContainer$$Internal_,
		pageInstance
	);
	addChild.call(
		this,
		'horizontalDivider',
		$MainContainer$$IntExtContainer$$HorizontalDivider_,
		pageInstance
	);
	addChild.call(
		this,
		'external',
		$MainContainer$$IntExtContainer$$External_,
		pageInstance
	);
}
...
const $MainContainer$$IntExtContainer_ = FlexLayout(
	$MainContainer$$IntExtContainer
);
function $MainContainer$$IntExtContainer$$IntExtTitle(_super, pageInstance) {
	_super(this, { text: 'LOREM IPSUM' });
...
const $MainContainer$$IntExtContainer$$IntExtTitle_ = TextView(
	$MainContainer$$IntExtContainer$$IntExtTitle
);
...
const $MainContainer$$IntExtContainer$$Internal_ = ListItemSwitch(
	$MainContainer$$IntExtContainer$$Internal
);

function $MainContainer$$IntExtContainer$$HorizontalDivider(
	_super,
	pageInstance
) {
	_super(this);
...
const $MainContainer$$IntExtContainer$$HorizontalDivider_ = HorizontalDivider(
	$MainContainer$$IntExtContainer$$HorizontalDivider
);
...
const $MainContainer$$IntExtContainer$$External_ = ListItemSwitch(
	$MainContainer$$IntExtContainer$$External
);
...
function $MainContainer$$NoteContainer(_super, pageInstance) {
	...
	addChild.call(
		this,
		'flexlayout97',
		$MainContainer$$NoteContainer$$Flexlayout97_,
		pageInstance
	);
	addChild.call(
		this,
		'description',
		$MainContainer$$NoteContainer$$Description_,
		pageInstance
	);
}
...
const $MainContainer$$NoteContainer_ = FlexLayout(
	$MainContainer$$NoteContainer
);
function $MainContainer$$NoteContainer$$Flexlayout97(_super, pageInstance) {
	...
	addChild.call(
		this,
		'noteTitle',
		$MainContainer$$NoteContainer$$Flexlayout97$$NoteTitle_,
		pageInstance
	);
	addChild.call(
		this,
		'imageview44',
		$MainContainer$$NoteContainer$$Flexlayout97$$Imageview44_,
		pageInstance
	);
}
$MainContainer$$NoteContainer$$Flexlayout97.$$styleContext = {
	classNames: '.flexLayout',
	defaultClassNames: '.default_common .default_flexLayout',
	userProps: { flexProps: { flexDirection: 'ROW' }, height: 25, width: null }
};
const $MainContainer$$NoteContainer$$Flexlayout97_ = FlexLayout(
	$MainContainer$$NoteContainer$$Flexlayout97
);
function $MainContainer$$NoteContainer$$Flexlayout97$$NoteTitle(
	_super,
	pageInstance
) {
	_super(this, { text: 'NOTE' });
...
const $MainContainer$$NoteContainer$$Flexlayout97$$NoteTitle_ = TextView(
	$MainContainer$$NoteContainer$$Flexlayout97$$NoteTitle
);

function $MainContainer$$NoteContainer$$Flexlayout97$$Imageview44(
	_super,
	pageInstance
) {
	_super(this);
...
const $MainContainer$$NoteContainer$$Flexlayout97$$Imageview44_ = ImageView(
	$MainContainer$$NoteContainer$$Flexlayout97$$Imageview44
);
...
const $MainContainer$$NoteContainer$$Description_ = TextArea(
	$MainContainer$$NoteContainer$$Description
);
