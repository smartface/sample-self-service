...
// Constructor
function $PgSignUp(_super, props) {
	...
	pageContextPatch(this, 'pgSignUp');
}
$PgSignUp.$$styleContext = {
	classNames: '.page',
...
function onLoad() {
	// HeaderBar props
	this.headerBar.title = 'pgSignUp';
}

module.exports = $PgSignUp_;
