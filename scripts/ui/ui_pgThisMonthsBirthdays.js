...
//constructor
function $PgThisMonthsBirthdays(_super, props) {
  ...
  pageContextPatch(this, "pgThisMonthsBirthdays");
}
$PgThisMonthsBirthdays.$$styleContext = {
  classNames: ".page",
  userProps: {},
  statusBar: {
    classNames: "",
...
const $PgThisMonthsBirthdays_ = Page($PgThisMonthsBirthdays);
...
module && (module.exports = $PgThisMonthsBirthdays_);