...
// Constructor
function $PgCompanyDocuments(_super, props) {
  ...
  pageContextPatch(this, "pgCompanyDocuments");
}
$PgCompanyDocuments.$$styleContext = {
  classNames: ".page",
  userProps: {},
  statusBar: {
    classNames: "",
...
const $PgCompanyDocuments_ = Page($PgCompanyDocuments);
...
module.exports = $PgCompanyDocuments_;