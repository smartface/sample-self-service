...
const PgEmployeeDirectory_ = extend(Page)(
	//constructor
	function(_super, props) {
		...
		var layoutHeaderBar = new LayoutHeaderBar(layoutHeaderBarStyle, "pgEmployeeDirectory");
...
module && (module.exports = PgEmployeeDirectory_);